...
class ToastUtil {
    ...
    static errorRaw(title, message, autoCloseDelay = 3333) {
        this.show(TYPE_ERROR, title, message, true, autoCloseDelay);
    }
    static errorApi(error, title = 'common.fail-to-load-data', autoCloseDelay = 3333) {
    ...
    static show(type, title, message, rawMessage = false, autoCloseDelay = 3333) {
